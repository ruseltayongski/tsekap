...
=======
                            <div class="col-md-6">
                                <label for="facility-name">Name of Health Facility</label>
                                <input type="text" class="form-control" name="facilityname" id="facility"  value="{{ json_decode($facility, true)[0]['name'] ? json_decode($facility, true)[0]['name']  : 'N/A' }}">
                    ...
                    <h4 class="patient-font mt-4" style="background-color: #727DAB;color:white;padding: 2px;">I. PATIENT'S INFORMATION</h4>
                        <div class="row">
                            ...
                            <input type="hidden" name="profile_id" id="profile_id" value="{{ $profile->id ? $profile->id : '' }}">

                            <div class="col-md-3">
                                <label for="lname">Last Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="lname" maxlength="25" id="lname" value="{{ $profile->lname ? $profile->lname : '' }}" >
                            </div>
                            
                            <div class="col-md-3">
                                <label for="fname">First Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="fname" maxlength="25" id="fname" value="{{ $profile->fname ? $profile->fname : '' }}" >
                            </div>
                        
                            <div class="col-md-3">
                                <label for="mname">Middle Name</label>
                                <input type="text" class="form-control" name="mname" maxlength="25" id="mname" value="{{ $profile->mname ? $profile->mname  : '' }}" >
                            </div>
                            ...
                            <div class="col-md-3">  
                                ...
                                <input type="text" class="form-control" id="dateofbirth" name="dateBirth" value="{{ $profile->dob ? Carbon::parse($profile->dob)->format('F d, Y') : '' }}" >
                            </div>
                        
                            <div class="col-md-3">
                                <label for="age">Age</label>
                                <input type="text" class="form-control" id="age" name="age" value="{{ $profile->age ? $profile->age : '' }}" >
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3" id="other-religion-div">
                                ...
                                <input type="text" class="form-control" name="other_religion" id="other_religion" maxlength="50" placeholder="Please specify" value="{{ $profile->other_religion ? $profile->other_religion : '' }}" >
                            </div>

                            <div class="col-md-3">
                                <label for="contact">Contact Number <span class="text-danger" >*</span></label>
                                <input type="text" class="form-control" name="contact" id="contact" maxlength="11" value="{{ $profile->contact ? $profile->contact : '' }}">
                            </div>
                            <div class="row"></div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="street" id="street" maxlength="25" value="{{ $profile->street ? $profile->street : '' }}" >
                            </div>
                            <div class="col-md-4">
                                <label for="purok">Purok</label>
                                <input type="text" class="form-control" name="purok" id="purok" maxlength="25" value="{{ $profile->purok ? $profile->purok : '' }}" >
                            </div>
                            <div class="col-md-4">
                                <label for="sitio">Sitio</label>
                                <input type="text" class="form-control" name="sitio" id="sitio" maxlength="25" value="{{ $profile->sitio ? $profile->sitio : '' }}" >
                            </div>
                            <div class="col-md-5">
                                <label for="phic_id">PhilHealth No.</label>
                                <input type="text" class="form-control" name="phic_id" id="phic_id" maxlength="12" value="{{ $profile->phic_id ? $profile->phic_id : '' }}" ><br>
                            </div>
                            <div class="col-md-7">
                                <label for="pwd_id">Persons with Disability ID Card No. if applicable:</label>
                                <input type="text" class="form-control" name="pwd_id" id="pwd_id" maxlength="13" value="{{ $profile->pwd_id ? $profile->pwd_id : '' }}" ><br>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3" id="other-citizenship-div" >
                                ...
                                <input type="text" class="form-control" name="other_citizenship" id="other_citizenship" placeholder="Please specify citizenship" value="{{ $profile->other_citizenship ? $profile->other_citizenship : '' }}" >
                            </div> 
                ...
                <div class="additional-inputs">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="physicianName" name="physician_name" placeholder="Enter physician name" value="{{ $profile->riskForm->ar_refer_physician_name ? $profile->riskForm->ar_refer_physician_name : '' }}" >
                        </div>
                        <div class="col-md-4">
                            <label for="reason">Reason:</label>
                            <input type="text" class="form-control" id="reason" name="reason" placeholder="Enter reason" value="{{ $profile->riskForm->ar_refer_reason ? $profile->riskForm->ar_refer_reason : '' }}" >
                        </div>
                        <div class="col-md-4">
                            ...
                            <tbody style="border: 1px solid #000; padding: 10px; font-weight: bold;"> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <textarea class="col-md-12" id="diabetesDetailsInput"  name="pmh_diabetes_details"  placeholder="{{ $profile->riskForm->pmh_specify_diabetes ? $profile->riskForm->pmh_specify_diabetes : '' }}"  disabled></textarea>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <br/>    
                                         <textarea class="col-md-12" id="cancerDetailsInput" name="pmh_cancer_details"  placeholder="{{ $profile->riskForm->pmh_specify_cancer ? $profile->riskForm->pmh_specify_cancer : '' }}"  disabled></textarea>
                                    </td>
                                </tr>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <textarea class="col-md-12" id="allergiesDetailsInput"  name="pmh_allergies_details"  placeholder="{{ $profile->riskForm->pmh_specify_allergies ?$profile->riskForm->pmh_specify_allergies : '' }}"  disabled></textarea>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <textarea class="col-md-12" id="mnsDetailsInput" name="pmh_mnsad_details"  placeholder="{{ $profile->riskForm->pmh_specify_mn_and_s_disorder ? $profile->riskForm->pmh_specify_mn_and_s_disorder : '' }}"  disabled></textarea>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <textarea class="col-md-12" id="surgicalDetailsInput" name="pmh_psh_details" placeholder="{{ $profile->riskForm->pmh_specify_previous_surgical ? $profile->riskForm->pmh_specify_previous_surgical : '' }}"  disabled></textarea>
...
=======
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="textbox" id="weight" name="rf_weight" oninput="calculateBMI()" value="{{ $profile->riskForm->rf_weight ? $profile->riskForm->rf_weight : '' }}"  disabled> 
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="textbox" id="height"  name="rf_height" oninput="calculateBMI()" value="{{ $profile->riskForm->rf_height ? $profile->riskForm->rf_height : '' }}"  disabled> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="textbox" id="BMI" value="{{ $profile->riskForm->rf_body_mass ? $profile->riskForm->rf_body_mass : '' }}" name="rf_BMI"  disabled><p><i><span style="font-size: 13.5px; font-weight: 300; padding-left: 5px;" id="bmiStrVal" ></span></i></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="textbox" id="waist" name ="rf_waist" value="{{ $profile->riskForm->rf_waist_circumference ?$profile->riskForm->rf_waist_circumference : '' }}"  disabled> 
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                            ...
                            <td style="border: 1px solid #000; padding: 10px;">
                                ...
                                <div style="display:flex">
                                    <div style="margin-bottom: 10px; display: flex; flex-direction: column;">
                                        ...
                                        <input type="text" name="systolic_t1" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_systolic_t1 ? $profile->riskForm->rs_systolic_t1 : '' }}"  disabled> 
                                    </div>
                                    <div style="margin-bottom: 10px; display: flex; flex-direction: column;">
                                        <label>Diastolic:</label>
                                        <input type="text" name="diastolic_t1" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_diastolic_t1 ? $profile->riskForm->rs_diastolic_t1 : '' }}"  disabled>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div style="display:flex">
                                    <div style="margin-bottom: 10px; display: flex; flex-direction: column;">
                                        <label>Systolic:</label>
                                        <input type="text" name="systolic_t2" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_systolic_t2 ? $profile->riskForm->rs_systolic_t2 : '' }}"  disabled> 
                                    </div>
                                    <div style="margin-bottom: 10px; display: flex; flex-direction: column;">
                                        <label>Diastolic:</label>
                                        <input type="text" name="diastolic_t2" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_diastolic_t2 ? $profile->riskForm->rs_diastolic_t2 : '' }}"  disabled>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border: 1px solid #000; padding: 10px;">
                                <div style="margin-bottom: 10px;">
                                    ...
                                    <input type="text" name="fbs_result" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_blood_sugar_fbs ? $profile->riskForm->rs_blood_sugar_fbs : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>RBS Result:</label>
                                    <input type="text" name="rbs_result" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_blood_sugar_rbs ? $profile->riskForm->rs_blood_sugar_rbs : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>Date Taken:</label>
                                    <input type="date" name="bloodSugar_date_taken" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_blood_sugar_date_taken ? $profile->riskForm->rs_blood_sugar_date_taken : '' }}"  disabled>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border: 1px solid #000; padding: 10px;">
                                <input type="checkbox" name="rs_blood_sugar_symptoms[]" value="symptom1" 
                                    {{ in_array('polyphagia', explode(', ', $profile->riskForm->rs_blood_sugar_symptoms ? $profile->riskForm->rs_blood_sugar_symptoms  : '')) ? 'checked' : '' }}> Polyphagia 
                        
                                <input type="checkbox" name="rs_blood_sugar_symptoms[]" value="symptom2" 
                                    {{ in_array('polydipsia', explode(', ', $profile->riskForm->rs_blood_sugar_symptoms ? $profile->riskForm->rs_blood_sugar_symptoms : '')) ? 'checked' : '' }}> Polydipsia
                        
                                <input type="checkbox" name="rs_blood_sugar_symptoms[]" value="symptom3" 
                                    {{ in_array('polyuria', explode(', ', $profile->riskForm->rs_blood_sugar_symptoms ? $profile->riskForm->rs_blood_sugar_symptoms : '')) ? 'checked' : '' }}> Polyuria
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #000; padding: 10px;">
                                <div style="margin-bottom: 10px;">
                                    ...
                                    <input type="text" name="lipid_cholesterol" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_lipid_cholesterol ? $profile->riskForm->rs_lipid_cholesterol : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>HDL:</label>
                                    <input type="text" name="lipid_hdl" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_lipid_hdl ? $profile->riskForm->rs_lipid_hdl : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>LDL:</label>
                                    <input type="text" name="lipid_ldl" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_lipid_ldl ? $profile->riskForm->rs_lipid_ldl : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>VLDL:</label>
                                    <input type="text" name="lipid_vldl" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_lipid_vldl ? $profile->riskForm->rs_lipid_vldl : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>Triglyceride:</label>
                                    <input type="text" name="lipid_triglyceride" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_lipid_triglyceride ? $profile->riskForm->rs_lipid_triglyceride : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>Date Taken:</label>
                                    <input type="date" name="lipid_date_taken"  style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_lipid_date_taken ? $profile->riskForm->rs_lipid_date_taken : '' }}"  disabled>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #000; padding: 10px;">
                                <div style="margin-bottom: 10px;">
                                    <label>Protein:</label>
                                    <input type="text" name="uri_protein" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_urine_protein ? $profile->riskForm->rs_urine_protein : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>Date Taken:</label>
                                    <input type="date" name="uri_protein_date_taken"  style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_urine_protein_date_taken ? $profile->riskForm->rs_urine_protein_date_taken : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>Ketones:</label>
                                    <input type="text" name="uri_ketones" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_urine_ketones ? $profile->riskForm->rs_urine_ketones : '' }}"  disabled>
                                </div>
                                <div style="margin-bottom: 10px;">
                                    <label>Date Taken:</label>
                                    <input type="date" name="uri_ketones_date_taken" style="width: 95%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;" value="{{ $profile->riskForm->rs_urine_ketones_date_taken ? $profile->riskForm->rs_urine_ketones_date_taken : '' }}"  disabled>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td style="border: 1px solid #000; padding: 10px; ">
                                <div class="checkbox-group" style="display: flex; gap: 10px; flex-wrap: wrap;">
                                    <label style="margin-right: 20px;">
                                        ...
                                        {{ in_array('Breathlessness', explode(', ', $profile->riskForm->rs_chronic_respiratory_disease ? $profile->riskForm->rs_chronic_respiratory_disease : '')) ? 'checked' : '' }}> Breathlessness (or a 'need for air')
                                    </label>
                                    <label style="margin-right: 20px;">
                                        <input type="checkbox" name="symptom_sputum_production" 
                                        {{ in_array('Sputum (mucous) production', explode(', ', $profile->riskForm->rs_chronic_respiratory_disease ? $profile->riskForm->rs_chronic_respiratory_disease : '')) ? 'checked' : '' }}> Sputum (mucous) production
                                    </label>
                                    <label style="margin-right: 20px;">
                                        <input type="checkbox" name="symptom_chronic_cough" 
                                        {{ in_array('Chronic cough', explode(', ', $profile->riskForm->rs_chronic_respiratory_disease ? $profile->riskForm->rs_chronic_respiratory_disease: '')) ? 'checked' : '' }}> Chronic cough
                                    </label>
                                    <label style="margin-right: 20px;">
                                        <input type="checkbox" name="symptom_chest_tightness" 
                                        {{ in_array('Chest tightness', explode(', ', $profile->riskForm->rs_chronic_respiratory_disease ? $profile->riskForm->rs_chronic_respiratory_disease : '')) ? 'checked' : '' }}> Chest tightness
                                    </label>
                                    <label style="margin-right: 20px;">
                                        <input type="checkbox" name="symptom_wheezing" 
                                        {{ in_array('Wheezing', explode(', ', $profile->riskForm->rs_chronic_respiratory_disease ? $profile->riskForm->rs_chronic_respiratory_disease : '')) ? 'checked' : '' }}> Wheezing
                                    </label>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td style="border: 1px solid #000; padding: 10px;">
                                <div class="checkbox-group" style="display: flex; flex-direction: column; gap: 5px;">
                                    <label>
                                        ...
                                        {{ in_array('20% change from baseline (consider Probable Asthma)', explode(', ', $profile->riskForm->rs_if_yes_any_symptoms ? $profile->riskForm->rs_if_yes_any_symptoms : '')) ? 'checked' : '' }}> &gt; 20% change from baseline (consider Probable Asthma)
                                    </label>
                                    <label>
                                        <input type="checkbox" name="pefr_below_20_percent" 
                                        {{ in_array('20% change from baseline (consider Probable COPD)', explode(', ', $profile->riskForm->rs_if_yes_any_symptoms ? $profile->riskForm->rs_if_yes_any_symptoms : '')) ? 'checked' : '' }}> &lt; 20% change from baseline (consider Probable COPD)
                                    </label>
                                </div>
                            </td>
                        </tr>
                ...
                <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" name="follow_up_date" value="{{ $profile->riskForm->mngm_date_follow_up }}" 
                                    style="width: 100%; border: 1px solid #ccc; border-radius: 4px; padding: 8px;"  disabled>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="remarks" rows="3" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;"  disabled>{{ $profile->riskForm->mngm_remarks }} </textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
