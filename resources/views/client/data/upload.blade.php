        ...
        <div class="alert alert-jim">
            ...
            <form class="form-inline form-submit" method="POST" enctype="multipart/form-data" action="{{ asset('user/upload/data') }}">
                ...
                <div class="form-group">
                    <input type="file" name="file" id="fileSelected" class="file" accept=".DOH7v1-4" >
                    <div class="input-group col-xs-12">
                        <span class="input-group-addon"><i class="fa fa-file-excel-o"></i></span>
                        <input type="text" class="form-control input-md" disabled placeholder="Upload .DOH7v1-4 File">
...
<script>
    ...
    $('.form-submit').submit(function(e){
        ...
        function sendData()
        {
            var offsetUrl = "<?php echo url('user/upload/data/'); ?>";
