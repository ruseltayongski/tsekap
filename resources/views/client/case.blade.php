...
@section('content')
    ...
    <div class="col-md-9 wrapper">
        <div class="alert alert-jim">
            ...
            <h2 class="page-header">Diagnoses Report</h2>
                    ...
                    <table class="table table-striped talble-hover">
                        ...
                        @foreach($profiles as $p)
                            <tr>
                                ...
                                <td class="text-info">{{ Cases::find($p->case_id)->description }}</td>
                                <td class="text-info">
                                    @if($holder!=$p->profile_id)
                                        <?php $holder = $p->profile_id; ?>
                                ...
                                <td><a href="#remove" data-year="{{ date('Y',strtotime($p->dateProfile)) }}" data-toggle="modal" data-id="{{ $p->id }}" class="text-danger"><i class="fa fa-times"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="remove">
        <div class="modal-dialog modal-sm" role="document">
            <form method="POST" action="{{ asset('user/report/cases/delete') }}">
                {{ csrf_field() }}
